...
if __name__ == "__main__":
    ...
    # functional_model에서 에러가 발생한다.
    scripted_model = torch.jit.script(model)
    scripted_model.save('/tmp/resnet_functional.pt')

"""
torch.jit.frontend.UnsupportedNodeError: GeneratorExp aren't supported:
  File "/home/curt/.pyenv/versions/3.8.9/lib/python3.8/site-packages/pytorch_functional/src/functional_model.py", line 239
